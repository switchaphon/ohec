<!-- modal content -->
<form role="form" id="disableSchedule" name="disableSchedule" class="form-inline" data-toggle="validator" action="<?=site_url('schedule/disable_schedule_ops');?>" method="POST">    
